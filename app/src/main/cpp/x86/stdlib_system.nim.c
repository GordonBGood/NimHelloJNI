...
static N_INLINE(void, zeroMem__9cLyRtoQz0YlIMEd4qW7Hdgsystem)(void* p, NI size) {	nimZeroMem(p, size);
}
...
static N_INLINE(void, setBit__I4TSeZGFKfrVTL1oqiweCgsystem)(NI nr, NU32* dest) {	(*dest) = (NU32)((*dest) | (NU32)((NU32)(((NU32) 1)) << (NU32)((NI)(nr & ((NI) 31)))));
}
...
static N_INLINE(void, clearBit__I4TSeZGFKfrVTL1oqiweCg_2system)(NI nr, NU32* dest) {	(*dest) = (NU32)((*dest) & (NU32)((NU32) ~((NU32)((NU32)(((NU32) 1)) << (NU32)((NI)(nr & ((NI) 31)))))));
}
...
N_LIB_PRIVATE N_NIMCALL(void*, alloc__9aB7LvPFb7RSPI8u51kYo2Q_2)(tyObject_MemRegion__x81NhDv59b8ercDZ9bi85jyg* allocator, NI size) {	void* result;
	result = (void*)0;
...
N_LIB_PRIVATE N_NIMCALL(void*, alloc0__9aB7LvPFb7RSPI8u51kYo2Q)(tyObject_MemRegion__x81NhDv59b8ercDZ9bi85jyg* allocator, NI size) {	void* result;
	result = (void*)0;
	result = alloc__9aB7LvPFb7RSPI8u51kYo2Q_2(allocator, size);
	zeroMem__9cLyRtoQz0YlIMEd4qW7Hdgsystem(result, size);
	return result;
}
N_LIB_PRIVATE N_NOCONV(void*, alloc0__1Sx5YIRdVWZ4weqfKjYzWA)(NI size) {	void* result;
	result = (void*)0;
...
N_LIB_PRIVATE N_NIMCALL(void, init__wKM37ZoL6WtPOU9bn6Ug18A)(tyObject_CellSeq__Axo1XVm9aaQueTOldv8le5w* s, NI cap) {	void* T1_;
	...
	(*s).cap = cap;
	T1_ = (void*)0;
	T1_ = alloc0__1Sx5YIRdVWZ4weqfKjYzWA(((NI) ((NI)(cap * ((NI) 4)))));
...
N_LIB_PRIVATE N_NIMCALL(void, init__Y9c9cQhDWRSgYkHfKWcqFlsQ)(tyObject_CellSet__jG87P0AI9aZtss9ccTYBIISQ* s) {	void* T1_;
	T1_ = (void*)0;
	T1_ = alloc0__1Sx5YIRdVWZ4weqfKjYzWA(((NI) 4096));
...
N_LIB_PRIVATE N_NOCONV(void*, alloc__1Sx5YIRdVWZ4weqfKjYzWA_2)(NI size) {	void* result;
	result = (void*)0;
...
static N_INLINE(void, add__W9aRfhn7HvnQTPAb8ajo1uwsystem)(tyObject_CellSeq__Axo1XVm9aaQueTOldv8le5w* s, tyObject_Cell__1zcF9cV8XIAtbN8h5HRUB8g* c) {	{
		...
		T5_ = (void*)0;
		T5_ = alloc__1Sx5YIRdVWZ4weqfKjYzWA_2(((NI) ((NI)((*s).cap * ((NI) 4)))));
...
N_LIB_PRIVATE N_NIMCALL(void, cellSetEnlarge__9bhPFIGFYIneoHljx8OXvqA)(tyObject_CellSet__jG87P0AI9aZtss9ccTYBIISQ* t) {	NI oldMax;
	...
	T1_ = (void*)0;
	T1_ = alloc0__1Sx5YIRdVWZ4weqfKjYzWA(((NI) ((NI)((NI)((*t).max + ((NI) 1)) * ((NI) 4)))));
...
{	result = (tyObject_PageDesc__fublkgIY4LG3mT51LU2WHg*)0;
	...
	T19_ = (void*)0;
	T19_ = alloc0__1Sx5YIRdVWZ4weqfKjYzWA(((NI) 72));
...
N_LIB_PRIVATE N_NIMCALL(void, forAllSlotsAux__ld9axHPi9bpxevVrdgKiDF5Q)(void* dest, TNimNode* n, tyEnum_WalkOp__Wfy7gT5VQ8B3aJBxqU8D9cQ op) {	NI d;
	...
	{
		forAllChildrenAux__3hKpU9c72lqUqbltnsyFjRw(((void*) ((NI)((NU32)(d) + (NU32)((*n).offset)))), (*n).typ, op);
	}
	break;
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					{
						...
						{
							if (!((*(*(*n).sons[(i)- 0]).typ).kind == ((tyEnum_TNimKind__jIBKr1ejBgsfM33Kxw4j7A) 22) || (*(*(*n).sons[(i)- 0]).typ).kind == ((tyEnum_TNimKind__jIBKr1ejBgsfM33Kxw4j7A) 28) || (*(*(*n).sons[(i)- 0]).typ).kind == ((tyEnum_TNimKind__jIBKr1ejBgsfM33Kxw4j7A) 24))) goto LA12_;
							doOperation__sl6eqhLncFedgwzv6TlMVw((*((void**) ((NI)((NU32)(d) + (NU32)((*(*n).sons[(i)- 0]).offset))))), op);
						}
						goto LA10_;
						LA12_: ;
						{
							forAllChildrenAux__3hKpU9c72lqUqbltnsyFjRw(((void*) ((NI)((NU32)(d) + (NU32)((*(*n).sons[(i)- 0]).offset)))), (*(*n).sons[(i)- 0]).typ, op);
						}
						LA10_: ;
					}
					goto LA6_;
		...
		{
			{
				...
				res = ((NI) 0);
				{
					while (1) {
						...
						i = res;
						forAllChildrenAux__3hKpU9c72lqUqbltnsyFjRw(((void*) ((NI)((NU32)(d) + (NU32)((NI)((NU32)(i) * (NU32)((*(*mt).base).size)))))), (*mt).base, op);
						res += ((NI) 1);
					} LA14: ;
				}
			}
				...
				if (!!((s == NIM_NIL))) goto LA13_;
				{
					...
					res = ((NI) 0);
					{
						while (1) {
							...
							i = res;
							forAllChildrenAux__3hKpU9c72lqUqbltnsyFjRw(((void*) ((NI)((NU32)((NI)((NU32)(d) + (NU32)((NI)((NU32)(i) * (NU32)((*(*(*cell).typ).base).size))))) + (NU32)(((NI) 8))))), (*(*cell).typ).base, op);
							res += ((NI) 1);
						} LA17: ;
					}
				}
		...
		c = pageAddr__JNTkgd9cRu9a9bEvn7wS0U8EAsystem(p);
		{
			...
			if (!!(T8_)) goto LA9_;
			{
				...
				offset = (NI)((NU32)((NI)(((NI) (ptrdiff_t) (p)) & ((NI) 4095))) - (NU32)(((NI) 32)));
				{
					...
					d = ((tyObject_FreeCell__u6M5LHprqzkn9axr04yg9bGQ*) ((NI)((NU32)((NI)((NU32)(((NI) (ptrdiff_t) ((&(*c_2).data)))) + (NU32)(offset))) - (NU32)((NI)((NU32)(offset) % (NU32)((*c_2).Sup.size))))));
					{
			...
			LA14_: ;
			{
				...
				d_2 = (&(*c_3).data);
				{
					...
					T27_ = (((void*) (d_2)) <= p);
					if (!(T27_)) goto LA28_;
					T27_ = ((NU32)(((NI) 1)) < (NU32)((*((tyObject_FreeCell__u6M5LHprqzkn9axr04yg9bGQ*) (d_2))).zeroField));
					LA28_: ;
					if (!T27_) goto LA29_;
					result = ((void*) (d_2));
				}
	...
	LA4_: ;
	{
		...
		q = ((NI) (ptrdiff_t) (p));
		{
			...
			avlNode = inRange__BIq3l3oBvrBeYSWFT5iXiw((*a).root, q);
			{
				...
				{
					if (!((NU32)(((NI) 1)) < (NU32)((*((tyObject_FreeCell__u6M5LHprqzkn9axr04yg9bGQ*) (k))).zeroField))) goto LA45_;
					result = k;
				}
				LA45_: ;
			}
...
static N_INLINE(NIM_BOOL, isCell__knKGR9cPCi0isv7h4omKxdAsystem)(void* p) {	NIM_BOOL result;
	result = (NIM_BOOL)0;
	result = ((NU32)(((NI) 1)) < (NU32)((*((tyObject_FreeCell__u6M5LHprqzkn9axr04yg9bGQ*) (p))).zeroField));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, systemInit000)(void) {
{
	...
	strDesc__D0UzA4zsDu5tgpJQ9a9clXPg.size = ((NI) 4);
